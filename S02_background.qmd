...
obs = read_observations(scientificname = "Fratercula arctica") |>
  filter(month == "Mar")
...
plot(greedy_input['class'], 
     ...
     pch = ".", 
     extent = mask, 
     main = "March greedy class distribution",
     reset = FALSE)
...
plot(conservative_input['class'], 
     ...
     pch = ".", 
     extent = mask, 
     main = "March conservative class distribution",
     reset = FALSE)
plot(coast, col = "orange", add = TRUE)
```
...
make_model_input_by_month  = function(mon = "Jan",
                                      obs = read_observations("Fratercula arctica"),
                                      raster = NULL,
                                      species = "Fractercula arctica",
